...
# x is out data set loded into the model and y will be the output prediction from given input image
...
#As the number of epochs increases beyond 11,chance of overfitting of the model on training data
